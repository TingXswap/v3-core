...
import '../../../../../contracts/TingswapV3Pool.sol';
...
contract E2E_mint_burn {
    ...
    function check_mint_invariants(
        int24 _tickLower,
        int24 _tickUpper,
        TingswapMinter.MinterStats memory bfre,
        TingswapMinter.MinterStats memory aftr
    ) internal {
        (, int24 currentTick, , , , , ) = pool.slot0();
    ...
    function test_mint(uint128 _amount) public {
        ...
        (TingswapMinter.MinterStats memory bfre, TingswapMinter.MinterStats memory aftr) =
    ...
    function test_burn_partial(uint128 _amount) public {
        ...
        try minter.doBurn(pos.tickLower, pos.tickUpper, burnAmount) returns (
            TingswapMinter.MinterStats memory bfre_burn,
            TingswapMinter.MinterStats memory aftr_burn
        ) {
            bfre = bfre_burn;
            aftr = aftr_burn;
        } catch {
