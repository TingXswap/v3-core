...
describe('NoDelegateCall', () => {
  ...
  const noDelegateCallFixture = async () => {
    ...
    const noDelegateCallTest = (await noDelegateCallTestFactory.deploy()) as NoDelegateCallTest | any
    ...
    const proxy = (await minimalProxyFactory.deploy()) as NoDelegateCallTest | any
